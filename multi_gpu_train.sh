# This script launches independent Ray jobs (one GPU per seed); it is a
# multi-seed sweep, not data-parallel training. For one model replicated over
# multiple GPUs, use scripts/train_ddp.sh instead.
